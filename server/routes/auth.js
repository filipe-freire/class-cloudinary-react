...
// ℹ️ Handles cloudinary configuration
const multer = require('multer');
const cloudinary = require('cloudinary');
const multerStorageCloudinary = require('multer-storage-cloudinary');

// Configures cloudinary to use the URL specified in the .env
// as the CLOUDINARY_URL variable
...
router.post('/uploadFile/:id', upload.single('image'), (req, res) => {
  console.log(req.file);
  const id = req.params.id;

  User.findByIdAndUpdate(id, { profilePic: req.file.path })
    .then(() => {
      res.json({
